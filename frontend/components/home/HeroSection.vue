<template>
  <section class="w-full bg-gray-100 dark:bg-gray-800 relative -mt-[1px]">
    <div class="w-full h-screen relative overflow-hidden">
      ...
      <div
        class="container mx-auto px-8 sm:px-12 md:px-16 lg:px-24 xl:px-32 h-full flex flex-col justify-center relative z-10"
      >
        <!-- Center Logo -->
        <div class="flex flex-col items-center mb-12">
          <img
            ...
            class="h-32 mb-4 transition-opacity duration-300"
          />
...
const translations = {
  ...
  it: {
    ...
    heroSubtitle:
      "Unisciti alla nostra comunità e trasforma la tua vita con la guida di esperti in yoga, meditazione e vita consapevole.",
  },
  fr: {
    heroTitle: "Découvrez Votre Paix Intérieure Grâce au Yoga",
    heroSubtitle:
      "Rejoignez notre communauté et transformez votre vie avec les conseils d'experts en yoga, méditation et vie consciente.",
  },
  de: {
    heroTitle: "Entdecke Deinen Inneren Frieden Durch Yoga",
    heroSubtitle:
      "Werde Teil unserer Gemeinschaft und verändere dein Leben mit fachkundiger Anleitung in Yoga, Meditation und bewusstem Leben.",
  },
  zh: {
    heroTitle: "通过瑜伽发现内心平静",
    heroSubtitle:
      "加入我们的社区，在瑜伽、冥想和正念生活方面获得专业指导，改变您的生活。",
  },
};
